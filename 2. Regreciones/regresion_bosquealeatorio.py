...
dataset = pd.read_csv('machine-learning\3. Clasificacion\Position_Salaries.csv')
...
y_pred = regression.predict(np.array([[6]]))
# Mostrar el resultado de la predicción
print(f"Predicción para la posición 6: {y_pred[0]}")
